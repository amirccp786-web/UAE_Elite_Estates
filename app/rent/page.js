import { rentProperties } from "@/data/rentals";
import PropertyCard from "@/components/PropertyCard";

export default function Rent() {
  return (
    <>
      {/* Hero Section for Rent Page */}
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-headline text-white mb-6 tracking-tight drop-shadow-lg">
            Luxury Properties for <span className="text-[#c5a059]">Rent</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-light drop-shadow">
            Discover our exclusive collection of premium apartments and villas available for rent in Dubai's most sought-after neighborhoods.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-12">
            <div>
              ...
              <p className="text-gray-400 mb-4">Showing {rentProperties.length} luxury properties</p>
              <a 
                href="/Residential_real_estate_for_rent_in_Dubai.pdf" 
                target="_blank" 
